...
func tplMain(serverList string, currentServer string) string {
	...
	buf.WriteString(`</ul><ul class="nav navbar-nav navbar-right"><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Toolbox <span class="caret"></span></a><ul class="dropdown-menu"><li><a href="#filterServer" role="button" data-toggle="modal">Filter columns</a></li><li><a href="/sample?action=manageSamples" role="button">Manage samples</a></li><li><a href="/statistics?action=preference" role="button">Statistics preference</a></li><li class="divider"></li><li><a href="#settings" role="button" data-toggle="modal">Edit settings</a></li><li><a href="/user" role="button" data-toggle="modal">SMPP User PDU Search</a></li></ul></li>`)
